...
import { Eye, EyeOff, ArrowRight, Mail, Lock, User as UserIcon, Check } from 'lucide-react'
...
export default function Register() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // Login simple après inscription
          ...
          <form onSubmit={submit} className="flex flex-col gap-4">
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              ...
              <span className="text-xs text-gray-500 leading-relaxed">
                J'accepte les <Link to="#" className="text-violet-600 font-semibold hover:underline">Conditions d'utilisation</Link>
              </span>
            </label>
